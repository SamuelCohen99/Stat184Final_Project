...
The below plot is the Olympics Medals count of each country, with a couple of aesthetics added, such as a reorder, a fill, and a theme of the x-axis. This data is interesting when comparing this plot to the bar plot above because it is weird how the three countries with the top total medal counts are the same on both plots. 
